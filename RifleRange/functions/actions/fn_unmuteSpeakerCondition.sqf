scriptName "fn_unmuteSpeakerCondition";
/*
...
*/
#define SELF RR_fnc_unmuteSpeakerCondition

params [["_obj",objNull,[objNull]],["_actor",objNull,[objNull]],["_customParams",[],[[]]]];

_customParams params [["_rangeID","",[""]],["_laneIndecies",[],[[]]]];

(missionNamespace getVariable [format ["%1_SPEAKER_MUTE", _rangeID],false] && !isNil format ["%1_loudspeaker",_rangeID])
