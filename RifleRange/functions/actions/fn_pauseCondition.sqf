...
*/
#define SELF RR_fnc_pauseCondition
...
{
	if !(missionNamespace getVariable format ["%1_STATES_ARRAY", _rangeID] select _x select 3) exitWith {_condition = true};
