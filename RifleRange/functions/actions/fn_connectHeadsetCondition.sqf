scriptName "fn_connectHeadsetCondition";
/*
...
*/
#define SELF RR_fnc_connectHeadsetCondition

params [["_obj",objNull,[objNull]],["_actor",objNull,[objNull]],["_customParams",[],[[]]]];

_customParams params [["_rangeID","",[""]]];

private _playerItems = vestItems player + uniformItems player + backpackItems player + [goggles player] + [headgear player];

(player getVariable ["RR_connectedRange",""] != _rangeID && {count (RR_HEADSET_CLASSES arrayIntersect _playerItems) > 0})
