...
if (player getVariable ["RR_connectedRange",""] == _rangeID && {missionNamespace getVariable [format ["%1_CONTROL_OBJ",_rangeID],objNull] distance player < 500 && {goggles player == "G_WirelessEarpiece_F" || headgear player == "H_WirelessEarpiece_F"}}) then {
	playSound _sound;
};
